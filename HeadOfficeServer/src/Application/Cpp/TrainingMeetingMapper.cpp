...
namespace Tom_F
{
	...
	bool TrainingMeetingMapper::addToDatabase(DBControlIF& db, const TrainingMeeting& meeting) const
	{
	...
	int TrainingMeetingMapper::getAverageWaitingTime(DBControlIF& db, int healthClubID) const
	{
